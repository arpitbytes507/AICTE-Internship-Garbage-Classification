...
import { B as Block, S as Static, j as BlockLabel, X as Code$2, n as Empty, q as IconButton, K as Copy$1, D as DownloadLink, u as Download$1, o as IconButtonWrapper, Y as getWorkerProxyContext } from './2-DUa54J5L.js';
...
const lang_map = {
  python: () => import('./index32-DugpIsUd.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index33-DcPWqhQc.js'),
      import('./frontmatter-BeJv6jAb.js')
    ]);
  ...
  json: () => import('./index37-BAINrCIG.js').then((m) => m.json()),
  html: () => import('./index34-DDX7K1Ds.js').then((m) => m.html()),
  css: () => import('./index35-5gSe4fr1.js').then((m) => m.css()),
  javascript: () => import('./index36-Cpvo3I0e.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index36-Cpvo3I0e.js').then(
...
//# sourceMappingURL=Index16-CK2qn5Zz.js.map
